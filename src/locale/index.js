...
const mergeLang = languages => {
  ...
  languages.forEach(lang => {
    const iviewLocale = require('iview/dist/locale/' + lang.value + '.js').default; // 这里加载 iview 中的语言包
    const locale = require('./lang/' + lang.value + '.js').default; // 加载自己的语言包,自己语言设置跟iview保持一致
